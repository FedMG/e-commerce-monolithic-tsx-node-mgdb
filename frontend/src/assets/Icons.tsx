...
export const GreaterThanIcon = (): JSX.Element => (
  <SVGElement role='img' className='w-6 h-6 text-gray-400 fill-current' viewBox='0 0 20 20' ariaHidden labelledby=''>
...
export const StarIcon: FC<IconsProps> = ({ className }) => (
  <SVGElement role='img' className={`w-5 h-5 lg:w-6 lg:h-6 ${className}`} viewBox='0 0 20 20' ariaHidden labelledby=''>
...
export const CartIcon = (): JSX.Element => (
  <SVGElement role='img' className='w-5 h-5 mr-2 -ml-1 fill-current' ariaHidden viewBox='0 0 20 20' labelledby=''>
...
export const DownArrowIcon: FC<IconsProps> = ({ className }) => (
  <SVGElement role='img' className={`w-4 h-4 ml-2 fill-none stroke-2 stroke-current ${className}`} labelledby='' viewBox='0 0 24 24' ariaHidden>
    <SVGElement.Path d='M19 9l-7 7-7-7' />
  </SVGElement>
)

export const CloseIcon: FC<HamburgerIconProps> = ({ className, ariaHidden }) => (
  <SVGElement role='img' className={`stroke-gray-400 fill-gray-600 w-6 h-6 ${className}`} labelledby='' ariaHidden={ariaHidden} viewBox='0 0 20 20'>
...
export const DropItemIcon: FC<IconsProps> = ({ className }) => (
  <SVGElement role='img' className={className} labelledby='' viewBox='0 0 24 24' ariaHidden={false}>
...
export const GithubIcon: FC<IconsProps> = ({ className }) => (
  <SVGElement viewBox='0 0 24 24' role='img' labelledby='' className={className} ariaHidden={false}>
