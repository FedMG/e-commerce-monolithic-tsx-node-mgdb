...
export const ProductImage: React.FC<ProductImage> = ({ image }) => (
  // m-0.5 md:m-1
  <div className='relative aspect-[2/3] h-full xl:max-h-[310px] lg:max-h-[295px] md:max-h-[300px] sm:max-h-[255px] xs:max-h-[240px] max-h-[310px] flex items-center from-white to-gray-300 bg-gradient-to-br border-b border-gray-300'>
    <Image
      priority
      sizes='100vw'
      quality={20}
