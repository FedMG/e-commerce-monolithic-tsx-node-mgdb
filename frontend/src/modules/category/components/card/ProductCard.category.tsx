  ...
  return (
    <Link href='/[category]/[productId]' as={`/${category}/${id}`}>
      <div
        ...
        <Text className='opacity-0 group-hover/card:opacity-100 transition duration-300 easy-in-out bg-gray-100 group-hover/card:bg-gray-200 capitalize absolute top-[0.9%] left-[1.4%] md:top-[1%] md:left-[1.7%] z-30 rounded-br-md px-1 max-lg:text-sm lg:text-md font-semibold text-stone-700 border-r border-b shadow-b shadow-r'>
          {brand}
        </Text>
        <span onClick={handleClick}>
          <Heart className='absolute top-[3%] right-[5%] w-7 h-7 lg:w-8 lg:h-8 z-20 opacity-0 group-hover/card:opacity-100 transition duration-300 easy-in-out' />
        </span>
