...
export const Heart = (): React.ReactElement => {
  ...
  return (
    <SVGElement onClick={() => setLike(!isLike)} vBox={24} className={`w-7 h-7 sm:w-8 sm:h-8 lg:w-9 lg:h-9 ${isLike ? 'fill-rose-700 stroke-rose-700 hover:fill-rose-600 hover:stroke-rose-600' : 'fill-none stroke-slate-400 hover:stroke-rose-700'} stroke-2 select-none`}>
