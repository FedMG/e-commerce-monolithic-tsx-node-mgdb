  ...
  return (
    <div className='pt-10'>
      <div className='relative'>
        <CreateBlob className='top-15 left-20 md:left-5 -z-2 absolute w-[200px] h-[200px] md:w-[280px] md:h-[280px] lg:w-[580px] lg:h-[580px]'>
        ...
        <CreateBlob className='right-10 top-80 -z-2 absolute w-[240px] h-[240px] md:w-[290px] md:h-[290px] lg:w-[500px] lg:h-[500px]'>
